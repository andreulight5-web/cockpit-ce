...
const styles = {
  ...
  bubble: { background: '#FFFFFF', color: '#0F172A', borderRadius: 20, padding: '14px 20px', maxWidth: '85%', fontFamily: 'Poppins, sans-serif', fontSize: 15, fontWeight: 600, boxShadow: '0 8px 24px rgba(0,0,0,0.25)', position: 'relative', textAlign: 'center', lineHeight: 1.45 },
  bubbleTail: { position: 'absolute', bottom: -8, left: '50%', transform: 'translateX(-50%)', width: 0, height: 0, borderLeft: '10px solid transparent', borderRight: '10px solid transparent', borderTop: '10px solid #FFFFFF' },
