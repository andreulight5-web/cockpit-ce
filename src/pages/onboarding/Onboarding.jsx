...
const styles = {
  ...
  bubble: { background: '#FFFFFF', color: '#0F172A', borderRadius: 20, padding: '12px 18px', minWidth: 200, maxWidth: '85%', fontFamily: 'Poppins, sans-serif', fontSize: 15, fontWeight: 600, boxShadow: '0 8px 24px rgba(0,0,0,0.25)', position: 'relative', textAlign: 'center', lineHeight: 1.45, wordBreak: 'keep-all', overflowWrap: 'break-word', whiteSpace: 'normal' },
